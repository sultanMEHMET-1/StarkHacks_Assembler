# CLAUDE.md — Agent Guidelines for hand_localizer
...
14. **Using cube tag IDs (0-5) on the calibration board.** Calibration board tags use IDs 0-5. Cube should not be in vision when calibration board is. If ranges overlap, the detector can't tell cube tags from board tags, and both the cube pose and the board pose will be wrong.
